...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<UserModel> login(AuthRequestModel request) async {
  ...
  @override
  Future<TaskListResponseModel> getTasks({int limit = 10, int skip = 0}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit, r'skip': skip};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TaskListResponseModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TaskListResponseModel _value;
    try {
      _value = TaskListResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
